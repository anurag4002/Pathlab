...
const DEFAULT_MONGO_URI = 'mongodb+srv://mishraanurag66031_db_user:1CZzZbCbWw80LpKt@purepathlab.sejrekj.mongodb.net/purepathlab?retryWrites=true&w=majority';

module.exports = {
  PORT: process.env.PORT || 5001,
  MONGO_URI: process.env.MONGO_URI || DEFAULT_MONGO_URI,
  JWT_SECRET: process.env.JWT_SECRET || 'purepathlabsecretkey1234567890',
